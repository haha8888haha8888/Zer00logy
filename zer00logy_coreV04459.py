...
🤖🧻💬 : Type !@0ko@!/xexitx To Exit 0KO 3MAIb V0.04459
...
def run_symbolic_evaluation(emoji_shift=None):
    ...
    try:
        ...
        output.append(emoji_aware_pad("♾️🤖🧻♾️: 0KO 3MAI V0.04459 — ZeroKnockOut 3MiniAIBOT — ♾️🤖🧻♾️", 60, emoji_shift) + "\n")
        time.sleep(0.5)
    ...
    while True:
        try:
            ...
            menu_lines = [
                ...
                emoji_aware_pad("🤖🧻💬: Type !@0ko@!/xexitx To Exit 0KO 3MAIb V0.04459", 60, emoji_shift)
            ]
